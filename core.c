...
//#include "rpng.h"
// end of kocik adds 15.09.2021 10:54:18
...
// ####################### kocik add this 01.09.2021 17:12:35
//##############################################
//##############################################

bool ray_fullscreen = false;
            ...
            if (app->window != NULL)
            {
                ...
                else
                {
                    ...
                    CORE.Window.display.height = ANativeWindow_getHeight(CORE.Android.app->window);
                     ...
                     // kocik -----> 01.09.2021 17:30:20
                    //***********************************************************************
                   		
						  if(ray_fullscreen == true)
						  {
								// tego nie było !!!!
							  CORE.Window.currentFbo.width = CORE.Window.display.width;
							  CORE.Window.currentFbo.height = CORE.Window.display.height;
							  InitGraphicsDevice(CORE.Window.display.width, CORE.Window.display.height);
